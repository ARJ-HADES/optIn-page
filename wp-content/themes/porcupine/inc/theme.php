...
define('PORCUPINE_THEME_URL','https://wwwows.com/product/porcupine-wordpress-theme/');
define('PORCUPINE_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('PORCUPINE_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'porcupine_admin_theme_page_more_features' ) ) {
	function porcupine_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Porcupine Premium', 'porcupine' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'porcupine' ); ?></p>
    <a href="<?php echo esc_url(PORCUPINE_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Porcupine Premium', 'porcupine' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'porcupine_admin_theme_page_title' ) ) {
	function porcupine_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Porcupine WordPress Theme', 'porcupine' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Porcupine! Check all the theme features.', 'porcupine' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'porcupine' );?></h2>
</div>
<?php
	}
}    
 
// Porcupine admin page content   
if ( ! function_exists( 'porcupine_admin_theme_page' ) ) {
	function porcupine_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php porcupine_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span>Free</span> Porcupine features</h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PORCUPINE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'porcupine' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PORCUPINE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'porcupine' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PORCUPINE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'porcupine' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PORCUPINE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'porcupine' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PORCUPINE_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'porcupine' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Premium</span> Porcupine features</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'porcupine' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span>Additional blocks</span> for Porcupine premium</h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'porcupine' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'porcupine' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php porcupine_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'porcupine' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'porcupine' ); ?></p>
        <a href="<?php echo esc_url(PORCUPINE_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'porcupine' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'porcupine' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'porcupine' ); ?></p>
        <a href="<?php echo esc_url(PORCUPINE_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'porcupine' ); ?></a>
    </div>
</div>
<?php
	}
